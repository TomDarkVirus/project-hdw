...
loopback_config = [
    'interface loopback1', 'ip address 10.203.20.64 255.255.255.255'
]
...
static_route_config = [
    ...
    'ip route 10.10.0.0 255.255.0.0 10.0.5.1',
    'ip route 10.12.1.0 255.255.255.252 10.0.3.1',
    'ip route 10.12.2.0 255.255.255.252 10.0.3.1',
    'ip route 10.69.42.0 255.255.255.252 10.0.5.1',
    'ip route 172.16.0.0 255.255.0.0 10.0.3.1',
    'ip route 192.168.13.0 255.255.255.0 10.0.3.1'
]
