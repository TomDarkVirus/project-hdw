...
svi_ipv4_config = [
    ...
    'interface Vlan20', 'ip address 10.102.20.1 255.255.255.192', 'ip helper-address 192.168.13.41',
    'interface Vlan30', 'ip address 10.102.30.1 255.255.255.192', 'ip helper-address 192.168.13.41',
    'interface Vlan40', 'ip address 10.102.40.1 255.255.255.0', 'ip helper-address 192.168.13.41',
    'interface Vlan50', 'ip address 10.102.50.1 255.255.255.0', 'ip helper-address 192.168.13.41',
    'interface Vlan60', 'ip address 10.102.60.1 255.255.252.0', 'ip helper-address 192.168.13.41',
    'interface Vlan70', 'ip address 10.102.64.1 255.255.240.0', 'ip helper-address 192.168.13.41'
]
...
dhcp_ipv4_config = [
    ...
    'ip dhcp pool Vlan20', 'relay source 10.102.20.0 255.255.255.192', 'relay destination 192.168.13.41',
    'ip dhcp pool Vlan30', 'relay source 10.102.30.0 255.255.255.192', 'relay destination 192.168.13.41',
    'ip dhcp pool Vlan40', 'relay source 10.102.40.0 255.255.255.0', 'relay destination 192.168.13.41',
    'ip dhcp pool Vlan50', 'relay source 10.102.50.0 255.255.255.0', 'relay destination 192.168.13.41',
    'ip dhcp pool Vlan60', 'relay source 10.102.60.0 255.255.252.0', 'relay destination 192.168.13.41',
    'ip dhcp pool Vlan70', 'relay source 10.102.64.0 255.255.240.0', 'relay destination 192.168.13.41'
]
