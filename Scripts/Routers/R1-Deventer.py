...
dhcp_ipv4_config = [
    'ip dhcp excluded-address 10.101.20.1 10.101.20.10', 'ip dhcp pool Vlan20', 'relay source 10.101.20.0 255.255.255.192', 'relay destination 192.168.13.41', 'default-router 10.101.20.1', 'lease 0 8',
    'ip dhcp excluded-address 10.101.30.1 10.101.30.5', 'ip dhcp pool Vlan30', 'relay source 10.101.30.0 255.255.255.192', 'relay destination 192.168.13.41', 'default-router 10.101.30.1', 'lease 0 8',
    'ip dhcp excluded-address 10.101.40.1 10.101.40.5', 'ip dhcp pool Vlan40', 'relay source 10.101.40.0 255.255.255.0', 'relay destination 192.168.13.41', 'default-router 10.101.40.1', 'lease 0 8',
    'ip dhcp excluded-address 10.101.50.1 10.101.50.5', 'ip dhcp pool Vlan50', 'relay source 10.101.50.0 255.255.255.0', 'relay destination 192.168.13.41', 'default-router 10.101.50.1', 'lease 0 8',
    'ip dhcp excluded-address 10.101.60.1 10.101.60.5', 'ip dhcp pool Vlan60', 'relay source 10.101.60.0 255.255.252.0', 'relay destination 192.168.13.41', 'default-router 10.101.60.1', 'lease 0 8',
    'ip dhcp excluded-address 10.101.64.1 10.101.64.5', 'ip dhcp pool Vlan70', 'relay source 10.101.64.0 255.255.240.0', 'relay destination 192.168.13.41', 'default-router 10.101.64.1', 'lease 0 8'
]
