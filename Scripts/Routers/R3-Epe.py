...
loopback_config = [
    'interface loopback1', 'ip address 10.103.20.64 255.255.255.255'
]

# Define commands needed for SVI ipv4 configuration
svi_ipv4_config = [
    'interface Vlan20', 'ip address 10.103.20.1 255.255.255.192', 'ip helper-address 192.168.13.41',
    'interface Vlan30', 'ip address 10.103.30.1 255.255.255.192', 'ip helper-address 192.168.13.41',
    'interface Vlan40', 'ip address 10.103.40.1 255.255.255.0', 'ip helper-address 192.168.13.41',
    'interface Vlan50', 'ip address 10.103.50.1 255.255.255.0', 'ip helper-address 192.168.13.41',
    'interface Vlan60', 'ip address 10.103.60.1 255.255.252.0', 'ip helper-address 192.168.13.41',
    'interface Vlan70', 'ip address 10.103.64.1 255.255.240.0', 'ip helper-address 192.168.13.41'
]

# Define commands needed for L3 interface ipv4 configuration
l3_interface_ipv4_config = [
    'interface GigabitEthernet0/0/0', 'ip address 10.0.6.2 255.255.255.252',
    'interface GigabitEthernet0/0/1', 'ip address 10.0.6.10 255.255.255.252'
]

# Define commands needed for L3 interface ipv6 configuration
l3_interface_ipv6_config = [
    'interface GigabitEthernet0/0/0', 'ipv6 address 200:100:20:3::/64 eui-64',
    'interface GigabitEthernet0/0/1', 'ipv6 address 200:100:20:2::/64 eui-64',
...
dhcp_ipv4_config = [
    ...
    'ip dhcp pool Vlan20', 'relay source 10.103.20.0 255.255.255.192', 'relay destination 192.168.13.41',
    'ip dhcp pool Vlan30', 'relay source 10.103.30.0 255.255.255.192', 'relay destination 192.168.13.41',
    'ip dhcp pool Vlan40', 'relay source 10.103.40.0 255.255.255.0', 'relay destination 192.168.13.41',
    'ip dhcp pool Vlan50', 'relay source 10.103.50.0 255.255.255.0', 'relay destination 192.168.13.41', 
    'ip dhcp pool Vlan60', 'relay source 10.103.60.0 255.255.252.0', 'relay destination 192.168.13.41',
    'ip dhcp pool Vlan70', 'relay source 10.103.64.0 255.255.240.0', 'relay destination 192.168.13.41'
]
...
ospf_config = [
    ...
    'network 10.103.20.64 0.0.0.0 area 0',
...
static_route_config = [
    ...
    'ip route 10.10.0.0 255.255.0.0 10.0.6.9',
    'ip route 10.12.1.0 255.255.255.252 10.0.6.1',
    'ip route 10.12.2.0 255.255.255.252 10.0.6.1',
    'ip route 10.69.42.0 255.255.255.252 10.0.6.9',
    'ip route 10.69.43.0 255.255.255.252 10.0.6.9',
    'ip route 10.69.44.0 255.255.255.252 10.0.6.1',
    'ip route 172.16.0.0 255.255.255.0 10.0.6.1',
    'ip route 192.168.13.0 255.255.255.0 10.0.6.1',
    'ip route 192.168.100.0 255.255.255.0 10.0.6.1'
]
