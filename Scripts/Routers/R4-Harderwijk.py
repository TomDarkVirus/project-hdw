...
dhcp_ipv4_config = [
    ...
    'ip dhcp pool Vlan20', 'relay source 10.201.20.0 255.255.255.192', 'relay destination 192.168.13.41',
    'ip dhcp pool Vlan30', 'relay source 10.201.30.0 255.255.255.192', 'relay destination 192.168.13.41',
    'ip dhcp pool Vlan40', 'relay source 10.201.40.0 255.255.255.0', 'relay destination 192.168.13.41',
    'ip dhcp pool Vlan50', 'relay source 10.201.50.0 255.255.255.0', 'relay destination 192.168.13.41',
    'ip dhcp pool Vlan60', 'relay source 10.201.60.0 255.255.252.0', 'relay destination 192.168.13.41',
    'ip dhcp pool Vlan70', 'relay source 10.201.64.0 255.255.240.0', 'relay destination 192.168.13.41'
]
